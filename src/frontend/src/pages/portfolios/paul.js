...
import { Linkedin, Github, Envelope, Download, TelephoneFill} from "react-bootstrap-icons";
    ...
    return(
        <div className = "paulContainer">
            <div className="paulHome">
                ...
                <div className="paulHeader">
                    <div className="paulHeaderLeft">
                        ...
                        <a href="https://www.linkedin.com/in/paul-spadaccini/" className="paulLinkedLogos">
                            <Linkedin  color="#0A66C2"/>
                        </a>
                        <a href="https://github.com/spadpaul" className="paulLinkedLogos">
                            <Github color="black"/>
                        </a>
                        <a href="https://leetcode.com/spadpaul/" className="paulLinkedLogos">
            ...
            <div className="paulExperience">
                ...
                <h1>EDUCATION</h1>
                <h3>Pace University, Seidenberg School Computer Science and Information Systems</h3>
                    <p>Bachelor of Science (BS) in Computer Science | Concentration: Software Development | Minor: Mathematics | May 2022</p><br/>
                    <p>Honors: Magna Cum Laude | Alpha Chi (Member) | Deans List (Fall 2018 - Spring 2022) | GPA: 3.83</p>

                <h1>EXPERIENCE</h1>
                    <h2>Game Reviewz, Freelance Developer</h2>
                    <p>January 2023 - Present</p>
                    <ul>
                        <li>Collaborate in team of three, engaging in bi-weekly sprints using React, JavaScript, Java, HTML, &amp; SCSS to create a user-friendly website hosting video game &amp; tech reviews, creating wireframes for each webpage using Figma prior to implementation</li>
                        <li>Create tasks in a backlog &amp; and assign them based on priority &amp; size to manage SDLC, implementing code using <a href="https://github.com/tydolla00/Game-Reviewz">GitHub</a></li>
                    </ul>   

                    <h2>Blue CoLab, Web Developer</h2>
                    <p>January 2022 - May 2022</p>
                    <ul>
                        <li>Collaborated in team of three to clean &amp; parse water/weather sensor data using Python to map data to sound, allowing users to interpret patterns related to changes in climate auditorily</li>
                        <li>Deployed Django to create website, using HTML &amp; CSS to code front-end features, including play controls &amp; project information</li>
                        <li>Created a <a href="https://bluecolab.pace.edu/everyone-deserves-real-time-water-data/"> blog post </a> highlighting project's scope &amp; usefulness in identifying &amp; averting water-based crises</li>
                    </ul>

                    <h2>NYC Department of Youth &amp; Community Development, Application Support Intern</h2>
                    <p>June 2021 - August 2021</p>
                    <ul>
                        <li>Supported organization employees in use &amp; operation of internal software applications, managing approximately 20 helpdesk tickets through ServiceDesk weekly &amp; providing virtual support to remote employees</li>
                        <li>Managed user accounts deploying User Management &amp; PTS to create new accounts &amp; assign the appropriate level of system access, as well as deactivate &amp; unlock accounts as requested</li>
                    </ul>

                <h1>ACADEMIC PROJECTS</h1>
                <h2><a href="https://github.com/paceuniversity/cs389f2021team2">PaceEats Mobile Application</a></h2>
                <p>October 2021 - December 2021</p>
                <ul>
                    <li>Collaborated with team of four to design &amp; create mobile application using Android Studio, allowing Pace students to track food intake, calories, &amp; weight, using Google Firebase to store &amp; manage user data</li>
                    <li>Coded application back-end using Java &amp; deployed XML to design user-friendly front-end, conducting demonstrations to showcase project progress after each sprint</li>
                    <li>Implemented Agile Methodology for software development lifecycle (SDLC) by creating user stories in backlog, conducting Scrum meetings twice a week, &amp; collaborating on implementing code</li>
                </ul>
            </div>
            ...
            <div className="paulResume">
                ...
                <buttton className="downloadButton">
            ...
            <div className="paulContact">
                ...
                <p>
                    If you are interested in hiring me, I can be reached in the following ways!
                </p>
                <table>
                    <tr>
                        <a href="tel:914-295-4201">
                            <td><TelephoneFill color="green"/></td>
                    ...
                    <tr>
                        <a href="https://www.linkedin.com/in/paul-spadaccini/">
                            <td><Linkedin  color="#0A66C2"/></td>
                            <td className="paulTableText">linkedin.com/in/paul-spadaccini/</td>
                        </a>
                    </tr>
                </table>
            </div>
